...
(def examples
  [{:text "Find relative intensity of fucosylated glycans in WHO grade 2,3 and 4 samples. "
   ...
   {:text "Find the frequency of spatial cluster 10 in WHO grade 2,3 and 4 samples."
    :params {:universal {:dim :WHO_grade, :feature "spatial_clust_10", :filters {:WHO_grade {"2" true, "3" true, "4" true}}}, :heatmap2 {:dim :WHO_grade, :filter {:Tumor_Diagnosis {"Astrocytoma" false, "GBM" true, "Oligodendroglioma" false}, :recurrence {"No" true}, :WHO_grade {"3" true, "4" true, "2" true}, :treatment {"Neoadjuvant_PD1_Trial_2" true, "Treatment_Naive" true}}}, :features {:feature-bio-feature-type nil, :feature-supertype "spatial", :scale "linear", :feature-broad_feature_type "Cells", :feature-feature_type "Spatial_Density", :feature-feature_variable "spatial_clust_10", :subfeature-0 "Macrophage_CD206", :subfeature-2 "Tcell_CD8"}, :violin {"blobWidth" 100, "blobSpace" "530"}, :heatmap {:filter {}}}
    }

   {:text "What is the density of Myeloid CD11b+HLADR+ cells between GBM and PXA samples?"
    :params {:universal {:dim :Tumor_Diagnosis, :feature "Myeloid_CD11b_HLADRplus_density", :filters {:Tumor_Diagnosis {"GBM" true, "PXA" true}}}, :heatmap2 {:dim :Tumor_Diagnosis, :filter {:Tumor_Diagnosis {"Astrocytoma" false, "GBM" true, "Oligodendroglioma" false, "PXA" true}, :recurrence {"No" true}, :WHO_grade {"3" true, "4" true, "2" true}, :treatment {"Neoadjuvant_PD1_Trial_2" true, "Treatment_Naive" true}}}, :features {:feature-bio-feature-type nil, :feature-supertype "spatial", :scale "linear", :feature-broad_feature_type "Cells", :feature-feature_type "Area_Density", :feature-feature_variable "Myeloid_CD11b_HLADRplus_density", :subfeature-0 "Macrophage_CD206", :subfeature-2 "Tcell_CD8"}, :violin {"blobWidth" 100, "blobSpace" "530"}, :heatmap {:filter {}}}}
          
   {:text "CD163 transcript counts in GBM, Astrocytoma and Oligodendroglioma."
    :params {:universal {:dim :Tumor_Diagnosis, :feature "CD163", :filters {:Tumor_Diagnosis {"GBM" true, "PXA" false, "Astrocytoma" true, "Oligodendroglioma" true}}}, :heatmap2 {:dim :Tumor_Diagnosis, :filter {:Tumor_Diagnosis {"Astrocytoma" true, "GBM" true, "Oligodendroglioma" true, "PXA" false}, :recurrence {"No" true}, :WHO_grade {"3" true, "4" true, "2" true}, :treatment {"Neoadjuvant_PD1_Trial_2" true, "Treatment_Naive" true}}}, :features {:feature-bio-feature-type nil, :feature-supertype "spatial", :scale "linear", :feature-broad_feature_type "RNA", :feature-feature_type "Immune_High", :feature-feature_variable "CD163", :subfeature-0 "Macrophage_CD206", :subfeature-2 "Tcell_CD8"}, :violin {"blobWidth" 100, "blobSpace" "530"}, :heatmap {:filter {}}}}

  {:text "EGFR transcript counts in GBM, Astrocytoma and Oligodendroglioma"
   :params {:universal {:dim :WHO_grade, :feature "EGFR", :filters {}}, :heatmap2 {:dim :WHO_grade, :filter {:Tumor_Diagnosis {"Astrocytoma" true, "GBM" true, "Oligodendroglioma" true, "PXA" false}, :recurrence {"No" true}, :WHO_grade {"3" true, "4" true, "2" true}, :treatment {"Neoadjuvant_PD1_Trial_2" true, "Treatment_Naive" true}}}, :features {:feature-bio-feature-type nil, :feature-supertype "spatial", :scale "linear", :feature-broad_feature_type "RNA", :feature-feature_type "Immune_Low", :feature-feature_variable "EGFR", :subfeature-0 "Macrophage_CD206", :subfeature-2 "Tcell_CD8"}, :violin {"blobWidth" 100, "blobSpace" "530"}, :heatmap {:filter {}}}}
