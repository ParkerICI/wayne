...
(def filter-features
  '{:ROI
   ...
   :site ("CHOP" "CoH" "Stanford" "UCLA" "UCSF"),
   :source_table ("NA" "cell_table_immune" "cell_table_tumor"),
   :treatment
