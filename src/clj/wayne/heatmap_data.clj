...
;;; Some data
(def data1 (wayne.data/select "avg(feature_value) as mean, feature_variable, final_diagnosis  {from}  \n where feature_type = 'marker_intensity' and 1 = 1\n group by feature_variable, final_diagnosis"))
